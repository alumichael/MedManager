 ...
 */
public class SearchDisplayActivity extends AppCompatActivity implements
       ...
       //TODO
        ...
        employeeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchDisplayActivity.this, AddReminderActivity.class);
                ...
                Uri currentEmployeeUri = ContentUris.withAppendedId(AlarmReminderContract.AlarmReminderEntry.CONTENT_URI, id);
