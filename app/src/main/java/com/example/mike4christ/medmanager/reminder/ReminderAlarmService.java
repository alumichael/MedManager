...
import com.example.mike4christ.medmanager.AddReminderActivity;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                description = AlarmReminderContract.getColumnString(cursor, AlarmReminderContract.AlarmReminderEntry.KEY_DESCRIPTION);
            }
        } finally {
            if (cursor != null) {
                cursor.close();
